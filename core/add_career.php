...
$id=$db->lastInsertId();
echo'<script>window.top.window.$("#careers").append(\'<div id="l_'.$id.'"><div class="row"><div class="col-12 col-md-3 pr-md-1"><label>Career Title</label><div class="form-row"><div class="form-text">'.$title.'</div></div></div><div class="col-12 col-md-3 pr-md-1"><label>Career Business</label><div class="form-row"><div class="form-text">'.$business.'</div></div></div><div class="col-12 col-md-3 pr-md-1"><label>Start Date</label><div class="form-row"><div class="form-text">'.($tis==0?'Current':date('Y-M',$tis)).'</div></div></div><div class="col-12 col-md-3"><label>End Date</label><div class="form-row"><div class="form-text">'.($tie==0?'Current':date('Y-M',$tie)).'</div></div></div></div><div class="row mt-3"><label>Career Notes</label><div class="col-12 col-md-11"><div class="form-row"><div class="form-text">'.$da.'</div></div></div><div class="col-12 col-md-1"><button class="btn-block trash" data-tooltip="tooltip" data-title="Delete" aria-label="Delete" onclick="purge(`'.$id.'`,`content`);">'.svg2('trash').'</button></div><hr></div></div>\');</script>';
