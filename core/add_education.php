...
echo'<script>'.
	'window.top.window.$("#education").append(\'<div id="l_'.$id.'">'.
		'<div class="form-group row">'.
			...
			'</div>'.
			'<div class="col-2">'.
				'<input type="text" class="form-control" value="'.($tis==0?'Current':date('Y-M',$tis)).'" readonly>'.
			'</div>'.
			'<div class="col-2">'.
				'<input type="text" class="form-control" value="'.($tie==0?'Current':date('Y-M',$tie)).'" readonly>'.
			'</div>'.
		'</div>'.
		'<div class="form-group row">'.
			'<div class="col">'.
