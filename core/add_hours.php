...
$id=$db->lastInsertId();?>
<script>
  window.top.window.$('#hours').append('<div id="l_<?php echo$id;?>" class="row item mt-1"><div class="col-12 col-md-2"><div class="form-row"><input type="text" value="<?php echo ucfirst($from);?>" readonly></div></div><div class="col-12 col-md-2"><div class="form-row"><input type="text" value="<?php echo ucfirst($to);?>" readonly></div></div><div class="col-12 col-md-2"><div class="form-row"><input type="text" value="<?php echo$timefrom;?>" readonly></div></div><div class="col-12 col-md-2"><div class="input-group-prepend"><input type="text" value="<?php echo$timeto;?>" readonly></div></div><div class="col-12 col-md-3"><div class="form-row"><input type="text" value="<?php echo$info;?>" readonly></div></div><div class="input-group col-12 col-md-1"><div class="form-row"><form target="sp" action="core/purge.php"><input name="id" type="hidden" value="<?php echo$id;?>"><input name="t" type="hidden" value="choices"><button class="trash" data-tooltip="tooltip" data-title="Delete" type="submit" aria-label="Delete"><?php echo svg('trash');?></button>&nbsp;&nbsp;<?php svg('drag','handle');?></form></div></div></div>');
			$('#hours').sortable({
				items:"div.item",
				handle:'.handle',
				placeholder:".ghost",
