...
(40, NULL, 0, 0, '00000000', 'dev', 'Notification 1637937679', 'slide-in-bottom', '', '', '', 'notification', '', '', '', '', '0000000000000000', '', '', 300, 3000, '', '', '', 'notification', 'Article', '', '', '', 'notification', '<p>This is a test notification.</p>', 1637937679, '0000000000000000', 1, 0, 0, 0, 1637937709),
(41, 0, 0, 1, '00000000', 'Anonymous', 'Biography', '', 'Biography SEO Title', '', '', 'biography', '', '', '', '', '0000000000000000', '', '', 300, 3000, '', '', '', 'biography', '', '', '', '', 'head', '<p>Kindie struth sleepout bonza donga banana bender. Mate yakka shazza got us some crack the shits mate sandgroppers rubbish. Trackie dacks gyno mullet give it a burl bathers to fossicker chuck a spaz. Fly wire amber fluid watch out for the pozzy ironman up yours roo. Battler pissed lizard drinking slappa. Vee dub cubby house yabber boardies apples. No wucka\'s bizzo she\'ll be apples vee dub pozzy bloody muster.</p><p>Reckon ken oath frog in a sock bities galah bazza unit ripper frog in a sock he\'s got a massive rapt. Cream yabber yakka smokes ford road train. Bikie tucker crook going off burk flanno. Trackie dacks bush bash bruce accadacca catcus. Outback lollies mates cut snake mickey mouse mate avo aussie salute feral defo. Ken oath sick shazza got us some bloody ute fair crack of the whip. Boardies mate\'s rates yabber what\'s crackin\' roo. Butcher knackered wrap your laughing gear \'round that better than a kick up the backside suss ankle biter bazza better than a kick up the backside. Footy freo grog mickey mouse mate dinky-di budgie smugglers bizzo two pot screamer. Bush gone walkabout bitzer throw a shrimp on the barbie rollie chuck a spaz ken oath. Roadie brizzie stubby holder she\'ll be right. Footy holy dooley trackies lets throw a.</p><p>Fair go, mate sunnies bodgy aerial pingpong built like a lollies vinnie\'s a cold one shoot through. Tell your story walkin\' full boar crow eaters no worries, mate, she\'ll be right. Brizzie grab us a sunnies waggin\' school ratbag vb gutful of few roos loose in the top paddock roo. Suss a few stubbies short of a six-pack christmas put a sock in it lippy. Blow in the bag damper dog\'s eye to dog\'s eye. Brekkie six of one, half a dozen of the other furthy mickey mouse mate no worries. Jillaroo top bloke digger roo bar accadacca fair dinkum burk scratchy also op shop.</p>', 4, '0000000000000000', 0, 1, 0, 0, 1638696355),
...
CREATE TABLE `orders` (
  ...
  `trackNumber` tinytext COLLATE utf8_bin NOT NULL,
...
CREATE TABLE `playlist` (
  `id` bigint NOT NULL,
  `rid` bigint NOT NULL,
  `width` varchar(6) COLLATE utf8_bin NOT NULL,
  `author_name` varchar(64) COLLATE utf8_bin NOT NULL,
  `author_url` varchar(256) COLLATE utf8_bin NOT NULL,
  `version` varchar(6) COLLATE utf8_bin NOT NULL,
  `provider_url` varchar(256) COLLATE utf8_bin NOT NULL,
  `provider_name` varchar(32) COLLATE utf8_bin NOT NULL,
  `thumbnail_width` varchar(6) COLLATE utf8_bin NOT NULL,
  `thumbnail_url` varchar(256) COLLATE utf8_bin NOT NULL,
  `height` varchar(6) COLLATE utf8_bin NOT NULL,
  `thumbnail_height` varchar(6) COLLATE utf8_bin NOT NULL,
  `html` text COLLATE utf8_bin NOT NULL,
  `url` varchar(256) COLLATE utf8_bin NOT NULL,
  `embed_url` varchar(256) COLLATE utf8_bin NOT NULL,
  `type` varchar(16) COLLATE utf8_bin NOT NULL,
  `title` tinytext COLLATE utf8_bin NOT NULL,
  `notes` text COLLATE utf8_bin NOT NULL,
  `ord` bigint NOT NULL,
  `active` tinyint(1) NOT NULL,
  `dt` tinytext COLLATE utf8_bin NOT NULL,
  `ti` int NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 COLLATE=utf8_bin;
...
(2, 400, 0, 'livechat', 'livechat', 'chat', 'Livechat', 11, 1),
...
(7, 400, 3, 'scheduler', 'scheduler', 'calendar-time', 'Scheduler', 11, 1),
...
(17, 400, 0, 'messages', 'messages', 'inbox', 'Messages', 10, 1),
(18, 400, 0, 'forum', 'forum', 'forum', 'Forum', 5, 1),
(19, 400, 0, 'newsletters', 'newsletters', 'newspaper', 'Newsletters', 9, 1),
...
(30, 400, 0, 'comments', 'comments', 'comments', 'Comments', 7, 1),
(31, 400, 0, 'reviews', 'reviews', 'review', 'Reviews', 8, 1),
(32, 400, 0, 'dropdown', 'settings', 'settings', 'Settings', 13, 1),
...
(43, 400, 0, 'dropdown', 'preferences', 'settings', 'Preferences', 12, 1),
...
(56, 400, 0, 'notification', 'notification', 'notification', 'Notifications', 14, 1),
(57, 400, 0, 'joblist', 'joblist', 'joblist', 'Job List', 16, 1),
(58, 900, 0, 'templates', 'templates', 'templates', 'Templates', 17, 1),
...
CREATE TABLE `tracker` (
  ...
  `countryName` varchar(128) COLLATE utf8_bin NOT NULL,
  `countryCode` varchar(32) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL,
  `city` varchar(128) COLLATE utf8_bin NOT NULL,
  `region` varchar(32) COLLATE utf8_bin NOT NULL,
  `regionCode` varchar(8) COLLATE utf8_bin NOT NULL,
  `browser` varchar(32) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL,
  `device` varchar(32) COLLATE utf8_bin NOT NULL,
  `viewportwidth` varchar(6) COLLATE utf8_bin NOT NULL,
...
CREATE TABLE `widgets` (
  ...
  `width` varchar(3) COLLATE utf8_bin NOT NULL,
  `ord` bigint NOT NULL,
  `active` tinyint(1) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 COLLATE=utf8_bin;
...
(10, 'dashboard', 'Latest AuroraCMS Updates', 'auroracmsupdates.php', '', '12', 11, 1),
