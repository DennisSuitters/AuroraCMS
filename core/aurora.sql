...
--
-- Host: localhost
-- Generation Time: Jan 26, 2024 at 05:09 PM
...
(1, 0, 0, 1, '00000000', 'Dennis Suitters', 'Home', 'Here is a heading for the Home Page.', 'Here\'s a Meta Title for the Home Page.Here\'s a Meta Title for', '', '', 'index', 'northern lights over snow-capped mountian', 'https://images.unsplash.com/photo-1531366936337-7c912a4589a7?w=1280&utm_source=AuroraCMS&utm_medium=referral', '', '', '0111110000000000', 'horizontal', 'fade', 300, 3000, 'northern lights over snow-capped mountian', 'Lightscape', 'https://unsplash.com/@lightscape?utm_source=AuroraCMS&utm_medium=referral', 'index', '', 'wood,turning,woodturned,timber,open,source,photography,digital,artwork,websit,design,development', 'Here\'s a Meta Title for the Home Page.Here\'s a Meta Title for', '', 'head', '<p class=\"\">Skeg ocker jillaroo dipstick brekkie thingo rego offsider&period; Dag up the duff devo blimey&period; Struth blimey dog&apos;s breakfast fisho tradie chock a block&period; Bush bash it&apos;ll be burk christmas rubbish metho jackaroo dead horse&period; Hard yakka top end chrissie banana bender <span>he&apos;s dreaming</span>&period; Heaps stuffed kero ugg boots chin wag onya bike decent nik skite&period; Good oil ropeable porky  cut lunch commando&period; Slab battler dardy oi tosser postie pint&period; Hit the turps bounce brumby chuck a yewy dipstick ropeable bloke dardy&period; Where mickey mouse mate shark biscuit roo bar footy&period; Yobbo bonza bludger sheila dog&apos;s eye boardies avo&period; Fair dinkum dunny rat going off sandgropper trackies&period; Nah&comma; yeah trackies it&apos;ll be fairy floss billabong chuck a spaz&period;</p><ul><li>Test</li><li>Test</li><li>test</li></ul><p><br></p>', 0, '0000000000000000', 1, 466, 0, 0, 1704116591),
(2, 0, 0, 1, '00000000', 'Dennis Suitters', 'Blog', '', '', '', '', 'article', '', '', '', '', '0000000000000000', '', '', 300, 3000, '', '', '', 'article', '', '', '', '', 'head', '', 7, '0000000000000000', 1, 133, 0, 0, 1697462295),
...
(7, 0, 0, 1, '00000000', 'Dennis Suitters', 'Testimonials', '', '', '', '', 'testimonials', '', '', '', '', '0000000000000000', '', '', 300, 3000, '', '', '', 'testimonials', '', '', '', '', 'head', '', 8, '0000000000000000', 1, 6, 0, 0, 1696989654),
(8, 0, 0, 1, '00000000', 'Dennis Suitters', 'Products', '', '', '', '', 'inventory', '', '', '', '', '0000000000000000', '', '', 300, 3000, '', '', '', 'inventory', '', '', '', '', 'head', '', 11, '0000000000000000', 1, 110, 0, 0, 1696989659),
...
(17, 0, 0, 1, '00000000', 'Dennis Suitters', 'Newsletters', '', '', '', '', 'newsletters', '', '', '', '', '0000000000000000', '', '', 300, 3000, '', '', '', 'newsletters', '', '', '', '', 'head', '', 18, '0000000000000000', 1, 4, 0, 0, 1696989668),
...
(26, 0, 0, 1, '00000000', 'Dennis Suitters', 'Forum', '', NULL, '', '', 'forum', '', '', '', '', '0000000000000000', '', '', 300, 3000, '', '', '', 'forum', 'Forum', '', '', '', 'head', '', 1, '0000000000000000', 1, 20, 0, 0, 1697542996),
...
(43, 0, 0, 1, '00000000', 'Dennis Suitters', 'Activities', '', '', '', '', 'activities', 'green and yellow tractor in garage', '', '', '', '0000000000000000', '', '', 300, 3000, '', '', '', 'activities', '', '', '', '', 'head', '', 2, '0000000000000000', 1, 8, 0, 0, 1697543297),
(44, 0, 0, 1, '00000000', 'Dennis Suitters', 'Courses', '', NULL, '', '', 'content', '', '', '', '', '0000000000000000', '', '', 300, 3000, '', '', '', 'course', 'Course', '', '', '', 'head', '', 17, '0000000000000000', 1, 8, 0, 0, 1696989667),
...
(50, 0, 0, 1, '00000000', 'Dennis Suitters', 'Pricing', '', '', '', '', 'pricing', '', '', '', '', '0000000000000000', '', '', 300, 3000, '', '', '', 'pricing', '', '', '', '', 'head', '', 3, '0000000000000000', 1, 2, 0, 0, 1697542997),
...
(3, 400, 0, 'content', 'dropdown', 'content', 'content', 'Content', 4, 0, 1, 2830),
...
(8, 400, 3, 'content', 'article', 'content', 'content', 'Articles', 2, 0, 1, 716),
...
(12, 400, 3, 'content', 'testimonials', 'content', 'testimonial', 'Testimonials', 20, 0, 1, 22),
(13, 400, 3, 'content', 'inventory', 'content', 'shipping', 'Inventory', 8, 0, 1, 119),
...
(18, 400, 3, 'content', 'forum', 'forum', 'forum', 'Forum', 7, 0, 1, 54),
(19, 400, 3, 'content', 'newsletters', 'newsletters', 'newspaper', 'Newsletters', 11, 0, 1, 218),
(20, 800, 0, '', 'bookings', 'bookings', 'calendar', 'Bookings', 3, 0, 1, 138),
...
(29, 800, 0, '', 'accounts', 'accounts', 'users', 'Accounts', 1, 0, 1, 610),
(30, 400, 3, 'content', 'comments', 'comments', 'comments', 'Comments', 3, 0, 1, 94),
(31, 400, 3, 'content', 'reviews', 'reviews', 'review', 'Reviews', 16, 0, 1, 38),
(32, 800, 0, 'settings', 'dropdown', 'settings', 'settings', 'Settings', 38, 0, 1, 606),
(33, 800, 32, 'settings', 'livechat', 'settings', 'chat', 'Livechat', 10, 0, 1, 96),
(34, 800, 32, 'settings', 'media', 'settings', 'picture', 'Media', 11, 0, 1, 110),
(35, 800, 32, 'settings', 'pages', 'settings', 'content', 'Pages', 15, 0, 1, 540),
(36, 800, 32, 'settings', 'content', 'settings', 'content', 'Content', 5, 0, 1, 158),
(37, 800, 32, 'settings', 'forum', 'settings', 'forum', 'Forum', 8, 0, 1, 20),
(38, 800, 32, 'settings', 'messages', 'settings', 'inbox', 'Messages', 12, 0, 1, 1278),
(39, 800, 32, 'settings', 'newsletters', 'settings', 'newspaper', 'Newsletters', 13, 0, 1, 26),
(40, 800, 32, 'settings', 'bookings', 'settings', 'calendar', 'Bookings', 2, 0, 1, 34),
(41, 800, 32, 'settings', 'orders', 'settings', 'order', 'Orders', 14, 0, 1, 1102),
(42, 800, 32, 'settings', 'accounts', 'settings', 'users', 'Accounts', 0, 0, 1, 56),
(44, 900, 32, 'settings', 'theme', 'settings', 'theme', 'Theme', 20, 0, 1, 16),
(45, 800, 32, 'settings', 'contact', 'settings', 'address-card', 'Contact', 4, 0, 1, 30),
(47, 900, 32, 'settings', 'interface', 'settings', 'sliders', 'Interface', 9, 0, 1, 132),
(48, 800, 32, 'settings', 'seo', 'settings', 'plugin-seo', 'SEO', 17, 0, 1, 22),
(49, 900, 32, 'settings', 'activity', 'settings', 'activity', 'Activity', 1, 0, 1, 30),
(50, 900, 32, 'settings', 'tracker', 'settings', 'tracker', 'Tracker', 21, 0, 1, 18),
(51, 900, 32, 'settings', 'cart', 'settings', 'shop-cart', 'Cart', 3, 0, 1, 20),
(52, 900, 32, 'settings', 'database', 'settings', 'database', 'Database', 7, 0, 1, 40),
(54, 900, 32, 'settings', 'security', 'settings', 'security', 'Security', 16, 0, 1, 36),
(55, 1000, 0, '', 'payments', 'payments', 'hosting', 'Payments', 37, 0, 1, 18),
(56, 400, 3, 'content', 'notification', 'notification', 'notification', 'Notifications', 12, 0, 1, 36),
(57, 800, 0, '', 'joblist', 'joblist', 'joblist', 'Job List', 26, 0, 1, 88),
(58, 900, 32, 'settings', 'templates', 'settings', 'templates', 'Templates', 19, 0, 1, 18),
(60, 400, 3, 'content', 'activities', 'content', 'activities', 'Activities', 0, 0, 1, 45),
(61, 400, 3, 'content', 'course', 'course', 'education-cap', 'Courses', 4, 0, 1, 174),
(62, 400, 3, 'content', 'adverts', 'adverts', 'blocks', 'Adverts', 1, 0, 1, 114),
(63, 800, 0, '', 'agronomy', 'agronomy', 'agronomy', 'Agronomy', 2, 0, 1, 1042),
(64, 800, 32, 'settings', 'course', 'settings', 'education-cap', 'Courses', 6, 0, 0, 10),
(65, 900, 32, 'settings', 'system', 'settings', 'system', 'System', 18, 0, 1, 54),
