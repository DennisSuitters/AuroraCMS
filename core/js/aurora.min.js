...
$(document).on(
  "click",
  ".analyzeTitle",function(){
    var el=$(this).data('test');
    var title=$('#'+el).val();
    if(title==''){
      toastr["error"]('Field needs text to analyze!');
    }else{
      window.open('https://headlines.sharethrough.com/?headline='+title, '_blank').focus();
    }
  }
);
$(document).on(
