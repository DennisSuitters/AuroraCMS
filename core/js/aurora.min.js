...
function toggleBookingView(){
	$('#calendar-view,.table-zebra').toggleClass('d-none');
...
function purge(id,t,c){
	...
	$.ajax({
      ...
      $('#li_'+id).addClass('animated zoomOut');
      setTimeout(function(){$('#li_'+id).remove();},500);      
    }else if(t=='modules'){
      $('#modules_'+id).addClass('animated zoomOut');
      setTimeout(function(){$('#modules_'+id).remove();},500);
    }else if(t=='module_questions'){
      $('#questions_'+id).addClass('animated zoomOut');
