...
(function($){
  ...
  $.extend($.summernote.plugins,{
    'pageTemplates': function (context){
      ...
      if (options.pageTemplates.cssFile != '' && !$("link[href='../summernote-templates/css/newsletter.css']").length){
        $('<link/>', {
          rel: 'stylesheet',
          type: 'text/css',
          ...
          ui.onDialogShown(self.$dialog, function () {
            ...
            $.get(options.pageTemplates.templates).done(function (data) {
              $(data).find("a").attr("href", function (i, val) {
                if (val.match(/\.(html)$/)) {
                  var filename = val.replace('.html', '.jpg');
            ...
            $pTBtn.click(function (e) {
              ...
              if (pageTemplatesSelected) {
                $.get(options.pageTemplates.templates + pageTemplatesSelected).done(function (data) {
                  if (options.pageTemplates.insertDetails == true) {
                    ...
                    var replace = [
                      ...
                      options.pageTemplates.yourPhone,
                      options.pageTemplates.logoImage,
                      options.pageTemplates.siteLink,
                      options.pageTemplates.socialLinkFacebook,
                      options.pageTemplates.socialLinkTwitter,
                      options.pageTemplates.socialLinkEmail,
                      options.pageTemplates.socialLinkLinkedIn
                    ];
                    data = data.replace(
