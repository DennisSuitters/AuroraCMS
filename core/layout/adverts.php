              ...
              <div id="controls_<?=$r['id'];?>">
                <div class="btn-toolbar float-right" role="toolbar">
                  <div class="btn-group" role="group">
                    <a class="btn" data-tooltip="tooltip" href="<?= URL.$settings['system']['admin'];?>/adverts/edit/<?=$r['id'];?>" role="button"<?=$user['options'][1]==1?' aria-label="Edit"':' aria-label="View"';?>><i class="i"><?=$user['options'][1]==1?'edit':'view';?></i></a>
