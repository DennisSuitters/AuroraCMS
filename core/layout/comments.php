            ...
            while($r=$s->fetch(PDO::FETCH_ASSOC)){
              ...
              <article class="card zebra mt-2 mb-0 p-0 overflow-visible card-list item shadow" id="l_<?=$r['id'];?>">
                <div class="row">
                  ...
                  <div class="col-12 col-md-4 py-2 align-top small"><?= strip_tags($r['notes']);?></div>
                  <div class="col-12 col-md-2 py-2 align-top small">
                  ...
                  <div class="col-12 col-md-2 py-2 text-center small"><?= date($config['dateFormat'],$r['ti']);?></div>
