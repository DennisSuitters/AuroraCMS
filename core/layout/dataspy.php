...
<?php while($r=$s->fetch(PDO::FETCH_ASSOC)){
    ...
    <tr id="l_<?php echo$r['id'];?>">
      <td class="small"><a href="<?php echo URL.$settings['system']['admin'].'/accounts/edit/'.$r['uid'];?>"><?php echo$r['username'].':'.$r['name'];?></a></td>
      <td class="text-center small"><?php echo$r['refTable'];?></td>
      <td class="text-center small"><?php echo$r['refColumn'];?></td>
      <td class="text-center small"><?php echo$r['contentType'];?></td>
