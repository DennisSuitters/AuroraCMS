        ...
        <div class="p-4">
          <div class="row">
            ...
            <div class="col-12 col-sm-4 pr-3">
              <label id="contenttie" for="tie"><?=$user['rank']>899?'<a class="permalink" href="'.URL.$settings['system']['admin'].'/bookings/edit/'.$r['id'].'#bookingTo" data-tooltip="tooltip" aria-label="PermaLink to Booked To Date Field">&#128279;</a>':'';?>To  <span class="labeldate" id="labeldatetie">(<?= date($config['dateFormat'],($r['tie']==0?$r['tis']:$r['tie']));?>)</span></label>
              <div class="form-row">
