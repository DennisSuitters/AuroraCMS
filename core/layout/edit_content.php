 ...
 * @changes    v0.0.20 Fix Images and Thumbnails not displaying correctly.
          ...
          if($r['contentType']!='testimonials'){?>
            <fieldset id="tab-content-images-2" class="control-fieldset">
              ...
              <div id="tab-content-images-6" class="form-group">
                ...
                <div class="input-group">
                  <input id="thumb" type="text" class="form-control textinput" value="<?php echo$r['thumb'];?>" data-dbid="<?php echo$r['id'];?>" data-dbt="content" data-dbc="thumb">
                  <div class="input-group-append">
                    <?php if($user['options'][1]==1){?>
                    ...
                    echo$user['options'][1]==1?'<button class="btn btn-secondary trash" onclick="imageUpdate(`'.$r['id'].'`,`content`,`thumb`,``);" data-tooltip="tooltip" data-title="Delete" aria-label="Delete">'.svg2('trash').'</button><button id="savethumb" class="btn btn-secondary save" data-tooltip="tooltip" data-title="Save" data-dbid="thumb" data-style="zoom-in" aria-label="Save">'.svg2('save').'</button>':'';?>
                  </div>
                </div>
              </div>
                ...
                <div id="mi" class="row">
                  ...
                  if($sm->rowCount()>0){
                    while($rm=$sm->fetch(PDO::FETCH_ASSOC)){
                      $bname=preg_replace('/\\.[^.\\s]{3,4}$/','',basename($rm['file'])).'.png';
                      ...
                      <div id="mi_<?php echo$rm['id'];?>" class="media-gallery d-inline-block col-6 col-sm-2 position-relative p-0 m-1 mt-0">
                        ...
                        <?php if($user['options'][1]==1){?>
                          <div class="btn-group float-right">
                            ...
                            <div class="btn btn-secondary btn-xs" data-tooltip="tooltip" data-title="Viewed <?php echo$rm['views'];?> times"><?php svg('view');echo' &nbsp;'.$rm['views'];?></div>
                            <a class="btn btn-secondary btn-xs" href="<?php echo URL.$settings['system']['admin'].'/media/edit/'.$rm['id'];?>" data-tooltip="tooltip" data-title="Edit"><?php svg('edit');?></a>
        ...
        <div class="col-12 col-md-3 order-1 order-md-2">
          ...
          <div class="card">
            <div class="card-body">
              ...
              <div class="card-text">
                <?php use DaveChild\TextStatistics as TS;
