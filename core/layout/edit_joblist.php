      ...
      <div class="card mt-3 border-radius-0 bg-transparent border-0 overflow-visible">
        ...
        <div class="row">
          <div class="col-12 col-sm-4 pr-md-3">
            <label for="tis">Booked <span class="labeldate" id="labeldatetis">(<?= date($config['dateFormat'],$r['tis']);?>)</span></label>
            <div class="form-row">
          ...
          <div class="col-12 col-sm-4 pr-mr-3">
            <label for="tie">To <span class="labeldate" id="labeldatetie">(<?= date($config['dateFormat'],$r['tie']);?>)</span></label>
            <div class="form-row">
