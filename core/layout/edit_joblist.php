        ...
        <div class="tabs">
          <div class="border p-3">
            <div class="row">
              ...
              <div class="col-12 col-sm-4 pr-md-3">
                <label for="tie" class="mt-0">To <span class="labeldate" id="labeldatetie">(<?= date($config['dateFormat'],$r['tie']);?>)</span></label>
                <div class="form-row">
            ...
            <div class="row">
              ...
              <div class="col-12 col-sm-6">
                <label for="notes2" onclick="$('#notes2').summernote({focus:true});">Result</label>
                <div class="form-row">
