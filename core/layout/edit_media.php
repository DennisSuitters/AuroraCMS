      ...
      <div class="card border-radius-0 shadow px-4 py-3 overflow-visible">
        <div class="row">
          <div class="col-12 col-md-10 order-1 order-md-1 mb-4 mb-md-0">
            <label id="mediaTitle" for="title"><?=$user['rank']>899?'<a class="permalink" data-tooltip="tooltip" href="'.URL.$settings['system']['admin'].'/media/edit/'.$r['id'].'#mediaTitle" aria-label="PermaLink to Media Title Field">&#128279;</a>':'';?>Title</label>
            <div class="form-row">
            ...
            <label id="mediaImageALT" for="fileALT"><?=$user['rank']>899?'<a class="permalink" data-tooltip="tooltip" href="'.URL.$settings['system']['admin'].'/media/edit/'.$r['id'].'#mediaImageALT" aria-label="PermaLink to Media Image ALT Field">&#128279;</a>':'';?>Image ALT</label>
            <div class="form-row">
        ...
        <label id="mediaTags" for="tags"><?=$user['rank']>899?'<a class="permalink" data-tooltip="tooltip" href="'.URL.$settings['system']['admin'].'/media/edit/'.$r['id'].'#mediaTags" aria-label="PermaLink to Media Tags Field">&#128279;</a>':'';?>Tags</label>
        <div class="form-row">
        ...
        <label id="mediaDateCreated" for="ti"><?=$user['rank']>899?'<a class="permalink" data-tooltip="tooltip" href="'.URL.$settings['system']['admin'].'/media/edit/'.$r['id'].'#mediaDateCreated" aria-label="PermaLink to Media Date Created Field">&#128279;</a>':'';?>Created</label>
        <div class="form-row">
          <input id="ti" type="text" value="<?= date($config['dateFormat'],$r['ti']);?>" readonly>
        </div>
        <label id="mediaViews" for="views"><?=$user['rank']>899?'<a class="permalink" data-tooltip="tooltip" href="'.URL.$settings['system']['admin'].'/media/edit/'.$r['id'].'#mediaViews" aria-label="PermaLink to Media Views Field">&#128279;</a>':'';?>Views</label>
        <div class="form-row">
        ...
        <div class="row">
          <div class="col-12 col-sm-6 pr-3">
            <label id="mediaCategoryOne" for="category_1"><?=$user['rank']>899?'<a class="permalink" data-tooltip="tooltip" href="'.URL.$settings['system']['admin'].'/media/edit/'.$r['id'].'#mediaCategoryOne" aria-label="PermaLink to Media Category One Field">&#128279;</a>':'';?>Category One</label>
            <div class="form-row">
          ...
          <div class="col-12 col-sm-6 pl-3">
            <label id="mediaCategoryTwo" for="category_2"><?=$user['rank']>899?'<a class="permalink" data-tooltip="tooltip" href="'.URL.$settings['system']['admin'].'/media/edit/'.$r['id'].'#mediaCategoryTwo" aria-label="PermaLink to Media Category Two Field">&#128279;</a>':'';?>Category Two</label>
            <div class="form-row">
        ...
        <div class="row">
          <div class="col-12 col-sm-6 pr-3">
            <label id="mediaCategoryThree" for="category_3"><?=$user['rank']>899?'<a class="permalink" data-tooltip="tooltip" href="'.URL.$settings['system']['admin'].'/media/edit/'.$r['id'].'#mediaCategoryThree" aria-label="PermaLink to Media Category Three Field">&#128279;</a>':'';?>Category Three</label>
            <div class="form-row">
          ...
          <div class="col-12 col-sm-6 pl-3">
            <label id="mediaCategoryFour" for="category_4"><?=$user['rank']>899?'<a class="permalink" data-tooltip="tooltip" href="'.URL.$settings['system']['admin'].'/media/edit/'.$r['id'].'#mediaCategoryFour" aria-label="PermaLink to Media Category Four Field">&#128279;</a>':'';?>Category Four</label>
            <div class="form-row">
        ...
        <label id="mediaEXIFFilename" for="exifFilename"><?=$user['rank']>899?'<a class="permalink" data-tooltip="tooltip" href="'.URL.$settings['system']['admin'].'/media/edit/'.$r['id'].'#mediaEXIFFilename" aria-label="PermaLink to Media EXIF Filename Field">&#128279;</a>':'';?>Original Filename</label>
        <div class="form-row">
        ...
        <label id="mediaEXIFCamera" for="exifCamera"><?=$user['rank']>899?'<a class="permalink" data-tooltip="tooltip" href="'.URL.$settings['system']['admin'].'/media/edit/'.$r['id'].'#mediaEXIFCamera" aria-label="PermaLink to Media EXIF Camera Field">&#128279;</a>':'';?>Camera</label>
        <div class="form-row">
        ...
        <label id="mediaEXIFLens" for="exifLens"><?=$user['rank']>899?'<a class="permalink" data-tooltip="tooltip" href="'.URL.$settings['system']['admin'].'/media/edit/'.$r['id'].'#mediaEXIFLens" aria-label="PermaLink to Media EXIF Lens Field">&#128279;</a>':'';?>Lens</label>
        <div class="form-row">
        ...
        <label id="mediaEXIFAperture" for="exifAperture"><?=$user['rank']>899?'<a class="permalink" data-tooltip="tooltip" href="'.URL.$settings['system']['admin'].'/media/edit/'.$r['id'].'#mediaEXIFAperture" aria-label="PermaLink to Media EXIF Aperture Field">&#128279;</a>':'';?>Aperture</label>
        <div class="form-row">
        ...
        <label id="mediaEXIFFocalLength" for="exifFocalLength"><?=$user['rank']>899?'<a class="permalink" data-tooltip="tooltip" href="'.URL.$settings['system']['admin'].'/media/edit/'.$r['id'].'#mediaEXIFFocalLength" aria-label="PermaLink to Media EXIF Focal Length Field">&#128279;</a>':'';?>Focal Length</label>
        <div class="form-row">
        ...
        <label id="mediaEXIFShutterSpeed" for="exifShutterSpeed"><?=$user['rank']>899?'<a class="permalink" data-tooltip="tooltip" href="'.URL.$settings['system']['admin'].'/media/edit/'.$r['id'].'#mediaEXIFShutterSpeed" aria-label="PermaLink to Media EXIF Shutter Speed Field">&#128279;</a>':'';?>Shutter Speed</label>
        <div class="form-row">
        ...
        <label id="mediaEXIFISO" for="exifISO"><?=$user['rank']>899?'<a class="permalink" data-tooltip="tooltip" href="'.URL.$settings['system']['admin'].'/media/edit/'.$r['id'].'#mediaEXIFISO" aria-label="PermaLink to Media EXIF ISO Field">&#128279;</a>':'';?>ISO</label>
        <div class="form-row">
        ...
        <label id="mediaEXIFDateTaken" for="exifti"><?=$user['rank']>899?'<a class="permalink" data-tooltip="tooltip" href="'.URL.$settings['system']['admin'].'/media/edit/'.$r['id'].'#mediaEXIFDateTaken" aria-label="PermaLink to Media EXIF Date Taken Field">&#128279;</a>':'';?>Date&nbsp;Taken</label>
        <div class="form-row">
        ...
        <label id="mediaAttributionImageName" for="attributionImageName"><?=$user['rank']>899?'<a class="permalink" data-tooltip="tooltip" href="'.URL.$settings['system']['admin'].'/media/edit/'.$r['id'].'#mediaAttributionImageName" aria-label="PermaLink to Media Image Attribution Name Field">&#128279;</a>':'';?>Name</label>
        <div class="form-row">
        ...
        <label id="mediaAttributionImageURL" for="attributionImageURL"><?=$user['rank']>899?'<a class="permalink" data-tooltip="tooltip" href="'.URL.$settings['system']['admin'].'/media/edit/'.$r['id'].'#mediAttributionImageURL" aria-label="PermaLink to Media Image Attribution URL Field">&#128279;</a>':'';?>URL</label>
        <div class="form-row">
