 ...
 * @changes    v0.0.20 Allow Image Uploading for Coming Soon and Maintenance pages.
    ...
    <div class="card col-12 col-md-9 order-2 order-md-1 px-0">
      <div class="card-body">
        <ul class="nav nav-tabs" role="tablist">
          ...
          <?php echo$r['contentType']!='comingsoon'&&$r['contentType']!='maintenance'?'<li role="presentation" class="nav-item"><a class="nav-link" href="#tab-pages-media" aria-controls="tab-pages-media" role="tab" data-toggle="tab">Media</a></li>':'';?>
            ...
            <div class="form-group">
              ...
              <div class="input-group">
                ...
                <div class="input-group-append">
                  ...
                  if($r['cover']!='')
                    echo'<a data-fancybox="cover" data-type="image" href="'.$r['cover'].'"><img id="coverimage" class="bg-white" src="'.$r['cover'].'" alt="'.$r['title'].'"></a>';
                  elseif($r['coverURL']!='')
                    echo'<a data-fslightbox="cover" data-type="image" href="'.$r['coverURL'].'"><img id="coverimage" class="bg-white" src="'.$r['coverURL'].'" alt="'.$r['title'].'"></a>';
                  elseif($r['coverURL'] != '')
                    echo'<a data-fslightbox="cover" data-type="image" href="'.$r['coverURL'].'"><img id="coverimage" class="bg-white" src="'.$r['coverURL'].'" alt="'.$r['title'].'"></a>';
                  else
                    echo'<img id="coverimage" class="bg-white" src="'.ADMINNOIMAGE.'" alt="'.$r['title'].'">';
                  echo$user['options'][1]==1?'<button class="btn btn-secondary trash" onclick="coverUpdate(`'.$r['id'].'`,`menu`,`cover`,``);" data-tooltip="tooltip" data-title="Delete" aria-label="Delete">'.svg2('trash').'</button>':'';?>
                  </div>
                </div>
              </div>
              <?php if($r['contentType']!='comingsoon'&&$r['contentType']!='maintenance'){?>
