...
<?php           if($user['options']{1}==1){
                ...
                <?php echo$user['options']{1}==1?'<div class="input-group-append" data-tooltip="tooltip" data-placement="top" title="Add Suggestion"><button class="btn btn-secondary addsuggestion" data-dbgid="title" aria-label="Add Suggestion">'.svg2('idea').'</button></div><div class="input-group-append" data-tooltip="tooltip" title="Save"><button id="savetitle" class="btn btn-secondary save" data-dbid="title" data-style="zoom-in" aria-label="Save">'.svg2('save').'</button></div>':'';?>
              </div>
              <script>
                function genurl(){
...
<?php           if($user['options']{1}==1){
                  ...
                  echo'<span class="d-flex justify-content-end" data-tooltip="tooltip" title="Add Suggestion"><button class="btn btn-secondary btn-sm addsuggestion" data-dbgid="notesda" aria-label="Add Suggestion">'.svg2('idea').'</button></span>';?>
            ...
            <fieldset class="control-fieldset">
              ...
              <div class="form-group row">
                ...
                <div class="input-group col-sm-10">
                  ...
                  <?php echo$user['options']{1}==1?'<div class="input-group-append"><button class="btn btn-secondary trash" onclick="coverUpdate(`'.$r['id'].'`,`menu`,`coverURL`,``);" data-tooltip="tooltip" title="Delete" aria-label="Delete">'.svg2('trash').'</button></div>':'';?>
                </div>
              </div>
              <div class="form-group row">
                ...
                <div class="input-group col-sm-10">
                  ...
                  <?php echo$user['options']{1}==1?'<div class="input-group-append"><button class="btn btn-secondary" onclick="elfinderDialog(`'.$r['id'].'`,`menu`,`cover`);" data-tooltip="tooltip" title="Open Media Manager" aria-label="Open Media Manager">'.svg2('browse-media').'</button></div>':'';?>
                  ...
                  <?php echo$user['options']{1}==1?'<div class="input-group-append"><button class="btn btn-secondary trash" onclick="coverUpdate(`'.$r['id'].'`,`menu`,`cover`,``);" data-tooltip="tooltip" title="Delete" aria-label="Delete">'.svg2('trash').'</button></div>':'';?>
                </div>
              </div>
              <div id="tab-content-images-7" class="form-group row">
                ...
                <div class="input-group col-sm-10">
                  ...
                  <?php echo$user['options']{1}==1?'<div class="input-group-append" data-tooltip="tooltip" title="Save"><button id="savefileALT" class="btn btn-secondary save" data-dbid="fileALT" data-style="zoom-in" aria-label="Save">'.svg2('save').'</button></div>':'';?>
                </div>
              </div>
              <div class="form-group row">
                ...
                <div class="input-group col-sm-10">
                  ...
                  <?php echo$user['options']{1}==1?'<div class="input-group-append"><button class="btn btn-secondary" onclick="elfinderDialog(`'.$r['id'].'`,`menu`,`coverVideo`);" data-tooltip="tooltip" title="Open Media Manager" aria-label="Open Media Manager">'.svg2('browse-media').'</button></div><div class="input-group-append"><button class="btn btn-secondary trash" onclick="coverUpdate(`'.$r['id'].'`,`menu`,`coverVideo`,``);" data-tooltip="tooltip" title="Delete" aria-label="Delete">'.svg2('trash').'</button></div>':'';?>
                </div>
              </div>
            </fieldset>
            <fieldset class="control-fieldset">
              ...
              <div class="form-group row">
                ...
                <div class="input-group col-sm-10">
                  ...
                  <?php echo$user['options']{1}==1?'<div class="input-group-append" data-tooltip="tooltip" title="Save"><button id="saveattributionImageTitle" class="btn btn-secondary save" data-dbid="attributionImageTitle" data-style="zoom-in" aria-label="Save">'.svg2('save').'</button></div>':'';?>
                </div>
              </div>
              <div class="form-group row">
...
<?php }
                  echo'<div class="input-group-append" data-tooltip="tooltip" title="Save"><button id="saveattributionImageName" class="btn btn-secondary save" data-dbid="attributionImageName" data-style="zoom-in" aria-label="Save">'.svg2('save').'</button></div>';
}?>
                </div>
              </div>
              <div class="form-group row">
...
<?php }
                  echo'<div class="input-group-append" data-tooltip="tooltip" title="Save"><button id="saveattributionImageURL" class="btn btn-secondary save" data-dbid="attributionImageURL" data-style="zoom-in" aria-label="Save">'.svg2('save').'</button></div>';
}?>
                </div>
              </div>
            </fieldset>
  ...
  while($rm=$sm->fetch(PDO::FETCH_ASSOC)){
    if(file_exists('media/thumbs/'.substr(basename($rm['file']),0,-4).'.png'))$thumb='media/thumbs/'.substr(basename($rm['file']),0,-4).'.png';
                ...
                <div id="mi_<?php echo$rm['id'];?>" class="media-gallery d-inline-block col-6 col-sm-2 position-relative p-0 m-1 mt-0">
                  ...
                  <?php echo$user['options']{1}==1?'<div class="btn-group float-right"><div class="handle btn btn-secondary btn-sm" data-tooltip="tooltip" title="Drag to ReOrder this item" aria-label="Drag to ReOrder this item">'.svg2('drag').'</div><button class="btn btn-secondary trash btn-sm" onclick="purge(`'.$rm['id'].'`,`media`);" data-tooltip="tooltip" title="Delete" aria-label="Delete">'.svg2('trash').'</button></div>':'';?>
                </div>
<?php }?>
                <script>
                  $('#mi').sortable({
          ...
          <div id="tab-page-seo" class="tab-pane" role="tabpanel">
            <div class="form-group row">
              ...
              <div class="input-group col-sm-10">
                ...
                <?php echo$user['options']{1}==1?'<div class="input-group-addon"><button class="btn btn-secondary trash" onclick="$(`#views`).val(`0`);update(`'.$r['id'].'`,`menu`,`views`,`0`);" data-tooltip="tooltip" title="Clear" aria-label="Clear">'.svg2('eraser').'</button></div><div class="input-group-append" data-tooltip="tooltip" title="Save"><button id="saveviews" class="btn btn-secondary save" data-dbid="views" data-style="zoom-in" aria-label="Save">'.svg2('save').'</button></div>':'';?>
              </div>
            </div>
            ...
            <div class="form-group row">
              ...
              <div class="input-group col-sm-10">
                ...
                <?php echo$user['options']{1}==1?'<div class="input-group-append" data-tooltip="tooltip" title="Save"><button id="savemetaRobots" class="btn btn-secondary save" data-dbid="metaRobots" data-style="zoom-in" aria-label="Save">'.svg2('save').'</button></div>':'';?>
              </div>
            </div>
            <div class="form-group row">
...
<?php if($user['options']{1}==1){
                echo'<div class="input-group-prepend"><button class="btn btn-secondary" onclick="removeStopWords(`seoTitle`,$(`#seoTitle`).val());" data-tooltip="tooltip" title="Remove Stop Words" aria-label="Remove Stop Words">'.svg2('magic').'</button></div>';
  $ss=$db->prepare("SELECT rid FROM `".$prefix."suggestions` WHERE rid=:rid AND t=:t AND c=:c");
  $ss->execute([':rid'=>$r['id'],':t'=>'menu',':c'=>'seoTitle']);
                ...
                <?php echo$user['options']{1}==1?'<div class="input-group-append" data-tooltip="tooltip" title="Add Suggestion"><button class="btn btn-secondary addsuggestion" data-toggle="popover" data-dbgid="seoTitle" aria-label="Add Suggestion">'.svg2('idea').'</button></div><div class="input-group-append" data-tooltip="tooltip" title="Save"><button id="saveseoTitle" class="btn btn-secondary save" data-dbid="seoTitle" data-style="zoom-in" aria-label="Save">'.svg2('save').'</button></div>':'';?>
              </div>
            </div>
...
<?php if($user['options']{1}==1){
                ...
                <?php echo$user['options']{1}==1?'<div class="input-group-append" data-tooltip="tooltip" title="Add Suggestion"><button class="btn btn-secondary addsuggestion" data-toggle="popover" data-dbgid="seoDescription" aria-label="Add Suggestion">'.svg2('idea').'</button></div><div class="input-group-append" data-tooltip="tooltip" title="Save"><button id="saveseoDescription" class="btn btn-secondary save" data-dbid="seoDescription" data-style="zoom-in" aria-label="Save">'.svg2('save').'</button></div>':'';?>
              </div>
            </div>
            <div class="form-group row">
...
<?php if($user['options']{1}==1){
                ...
                <?php echo$user['options']{1}==1?'<div class="input-group-append" data-tooltip="tooltip" title="Add Suggestion"><button class="btn btn-secondary addsuggestion" data-toggle="popover" data-dbgid="seoKeywords" aria-label="Add Suggestion">'.svg2('idea').'</button></div><div class="input-group-append" data-tooltip="tooltip" title="Save"><button id="saveseoKeywords" class="btn btn-secondary save" data-dbid="seoKeywords" data-style="zoom-in" aria-label="Save">'.svg2('save').'</button></div>':'';?>
              </div>
            </div>
          </div>
