              ...
              while($r=$s->fetch(PDO::FETCH_ASSOC)){?>
                <tr class="item subsortable" id="l_<?php echo$r['id'];?>">
                  ...
                  <td class="align-top">
                    ...
                    if($sm->rowCount()>0){?>
                      <div class="d-block ml-5" id="subsortable_<?php echo$r['id'];?>">
                        <?php while($rm=$sm->fetch(PDO::FETCH_ASSOC)){?>
                          <div class="item zebra border-bottom position-relative" style="position:relative;" id="l_<?php echo$rm['id'];?>">
                      ...
                      <?php if($user['options'][1]==1){?>
                        <script>
                          $('#subsortable_<?php echo$r['id'];?>').sortable({
                            items:"div.item",
                            handle:".subhandle",
                            placeholder:".ghost2",
                            ...
                            update:function(e,ui){
                              var order=$("#subsortable_<?php echo$r['id'];?>").sortable("serialize");
                              $.ajax({
                                type:"POST",
                                dataType:"json",
