        ...
        <div class="container-fluid">
          <div class="card mt-3 border-0 bg-transparent overflow-visible">
            ...
            <section class="content overflow-visible list" id="sortable">
              <article class="card mx-2 mb-0 p-0 overflow-visible card-list card-list-header bg-white shadow sticky-top">
                <div class="row">
                  <div class="col-12 col-md align-middle pl-2 py-1">Page Title</div>
                  <div class="col-12 col-md-1 align-middle text-center py-1">Menu</div>
                  <div class="col-12 col-md-2 align-middle text-center py-1">Views</div>
                  <div class="col-12 col-md-1 align-middle text-center py-1 mx-4">Active</div>
              ...
              while($r=$s->fetch(PDO::FETCH_ASSOC)){
                ...
                <article id="l_<?=$r['id'];?>" class="card zebra m-2 mb-0 p-0 pt-2 overflow-visible card-list item shadow subsortable<?=($seoerrors>0?' badge" data-badge="There are '.$seoerrors.' SEO issues!':'');?>">
                  <div class="row">
