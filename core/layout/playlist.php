        ...
        <div class="card-actions">
          <div class="row">
            ...
            <div class="col-12 col-sm-2 text-right">
              <div class="btn-group">
                <?=$user['options'][7]==1?'<a class="btn" href="'.URL.$settings['system']['admin'].'/playlist/settings" role="button" data-tooltip="left" aria-label="Playlist Settings"><i class="i">settings</i></a>':'';?>
              </div>
            </div>
          </div>
        </div>
