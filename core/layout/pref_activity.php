        ...
        <div class="activities card">
          <div class="card-body">
            ...
            while($r=$s->fetch(PDO::FETCH_ASSOC)){
              ...
              if($r['action']=='create')
                $action.=' <span class="badge badge-success">Created</span><br>';
              if($r['action']=='update')
                $action.=' <span class="badge badge-success">Updated</span><br>';
              if($r['action']=='purge')
                $action.=' <span class="badge badge-danger">Purged</span><br>';
