...
<main id="content" class="main">
  ...
  <div class="container-fluid">
    <div class="card">
      <div class="card-body">
        <div id="businessErrorBlock" class="alert alert-danger<?php echo$config['business']!=''?' hidden':'';?>" role="alert">The Business Name has not been set. Some functions such as Messages,Newsletters and Booking will NOT function currectly.</div>
