...
<?php if($user['rank']==1000){?>
            <div class="row">
              ...
              <label for="prefAdminHoster" id="confighoster01">Hoster Site, for managing Web Hosting Accounts</label>
            </div>
            ...
            <div class="form-row">
              ...
              <button class="save" id="savehosterURL" data-tooltip="tooltip" data-dbid="hosterURL" data-style="zoom-in" aria-label="Save"><?= svg2('save');?></button>
            </div>
<?php }?>
  <?php /* Fix
                ...
                <?php while($rm1=$sm1->fetch(PDO::FETCH_ASSOC)){?>
                  <tr class="item subsortable" id="l_<?=$rm1['id'];?>">
                    ...
                    <td class="pt-2">
                      ...
                      if($sm2->rowCount()>0){?>
                        <div id="sidebardropdown<?=$rm1['id'];?>" class="mt-2 d-none">
                          <div class="row">
