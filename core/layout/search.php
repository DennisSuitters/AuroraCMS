...
$rank=0;
$show='search';
$search=isset($_POST['s'])?filter_input(INPUT_POST,'s',FILTER_UNSAFE_RAW):'';?>
<main>
      ...
      <div class="card mt-3 bg-transparent border-0 overflow-visible">
        ...
        <div class="row p-3">
          <?php if($_POST['s']!=''){
            ...
            $s->execute([':search'=>'%'.str_replace(' ','%',$search).'%']);
            while($r=$s->fetch(PDO::FETCH_ASSOC)){?>
              <div class="mt-4" id="google-title">
                <small><small class="badger badge-secondary"><?=ucwords($r['contentType']);?></small></small><br>
