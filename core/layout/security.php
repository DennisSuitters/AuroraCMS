...
*
* @category   Administration - Settings - Security
* @package    core/layout/security.php
...
*/
$sv=$db->query("UPDATE `".$prefix."sidebar` SET `views`=`views`+1 WHERE `id`='54'")->execute();?>
<main>
      ...
      <div class="card mt-3 bg-transparent border-0 overflow-visible">
        ...
        <div class="tabs" role="tablist">
          ...
          <div class="tab1-6 border p-3" data-tabid="tab1-6" role="tabpanel">
            <legend>Google reCaptcha v2</legend>
