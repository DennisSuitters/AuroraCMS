 ...
 *
 * @category   Administration - Settings - SEO
 * @package    core/layout/seo.php
 ...
 */
$sv=$db->query("UPDATE `".$prefix."sidebar` SET `views`=`views`+1 WHERE `id`='48'")->execute();?>
<main>
    ...
    <div class="container-fluid">
      <div class="card mt-3 bg-transparent border-0 overflow-visible">
        ...
        <div class="tabs" role="tablist">
          ...
          '<label for="tab1-1">Defaults</label>'.
          '<input class="tab-control" id="tab1-2" name="tabs" type="radio">'.
          '<label for="tab1-2">Verifications</label>';?>
          <div class="tab1-1 border p-3" data-tabid="tab1-1" role="tabpanel">
            <legend class="mt-0">Fallback Information</legend>
          ...
          <div class="tab1-2 border p-3" data-tabid="tab1-2" role="tabpanel">
            <label for="gd_api" class="mt-0">Google Data API Key</label>
            ...
            <label for="seo_pinterestverify">Pinterest Verification</label>
            <div class="form-row">
