      ...
      <div class="card-body">
        ...
        <div class="form-group row">
          ...
          <div class="input-group col-sm-10">
            ...
            <div class="input-group-append" data-tooltip="tooltip" data-placement="top" title="Save"><button id="savebookingEmailSubject" class="btn btn-secondary save" data-dbid="bookingEmailSubject" data-style="zoom-in" aria-label="Save"><?php svg('save');?></button></div>
          </div>
        </div>
        <div class="form-group row">
        ...
        <div class="form-group row">
          ...
          <div class="input-group col-sm-10">
            ...
            <div class="input-group-append" data-tooltip="tooltip" title="Save"><button id="savebookingAutoReplySubject" class="btn btn-secondary save" data-dbid="bookingAutoReplySubject" data-style="zoom-in" aria-label="Save"><?php svg('save');?></button></div>
          </div>
        </div>
        <div class="form-group row">
          ...
          <div class="input-group col-sm-10">
            ...
            <div class="input-group-append"><button class="btn btn-secondary" onclick="elfinderDialog('1','config','bookingAttachment');" data-tooltip="tooltip" title="Open Media Manager" aria-label="Open Media Manager"><?php svg('browse-media');?></button></div>
            <div class="input-group-append"><button class="btn btn-secondary trash" onclick="coverUpdate('1','config','bookingAttachment','');" data-tooltip="tooltip" title="Delete" aria-label="Delete"><?php svg('trash');?></button></div>
          </div>
        </div>
        <div class="form-group row">
