 ...
 */
$sv=$db->query("UPDATE `".$prefix."sidebar` SET `views`=`views`+1 WHERE `id` IN ('32','64')")->execute();?>
<main>
          ...
          <div class="row">
            <div class="col-12 col-sm-6">
              <ol class="breadcrumb m-0 pl-0 pt-0">
                <li class="breadcrumb-item active"><a href="<?= URL.$settings['system']['admin'].'/content/type/course';?>">Course</a></li>
