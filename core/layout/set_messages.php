    ...
    <div class="container-fluid">
      <div class="card mt-3 bg-transparent border-0 overflow-visible">
        ...
        <div class="form-row">
          ...
          <label class="p-0 mt-0 ml-3" for="storeMessages">Store Contact Form Messages</label>
        </div>
        ...
        <hr>
        <legend class="mt-3 mb-0">Webmail</legend>
        ...
        <div class="form-row mt-3">
          ...
          <label class="p-0 mt-0 ml-3" for="deleteRetrievedMessages">Delete Retrieved Messages</label>
        </div>
        <legend class="mt-3 mb-0">Mailboxes</legend>
        <?php if($user['options'][7]==1){?>
        ...
        <hr>
        <legend class="mt-3 mb-0">AutoReply Email</legend>
        <div class="form-row">
          <label>Subject</label>
          <?php if($user['options'][7]==1){?>
        ...
        <hr>
        <legend class="mt-3 mb-0">Email Signature</legend>
        <div class="row">
          <?php if($user['options'][7]==1){?>
            <form class="w-100" method="post" target="sp" action="core/update.php">
              <input name="id" type="hidden" value="1">
