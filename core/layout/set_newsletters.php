 ...
 *
 * @category   Administration - Settings - Newsletters
 * @package    core/layout/set_newsletters.php
 ...
 */
$sv=$db->query("UPDATE `".$prefix."sidebar` SET `views`=`views`+1 WHERE `id` IN ('32','39')")->execute();?>
<main>
      ...
      <div class="card mt-3 bg-transparent border-0 overflow-visible">
          ...
          <div class="row">
            <div class="col-12 col-sm-6">
              <ol class="breadcrumb m-0 pl-0 pt-0">
                <li class="breadcrumb-item active"><a href="<?= URL.$settings['system']['admin'].'/newsletters';?>">Newsletters</a></li>
        ...
        <div class="tabs">
          <div class="border p-3">
            ...
            <hr>
            <label for="optOutLayout" class="mt-0" onclick="$('#optOutLayout').summernote({focus:true});">Opt Out Message</label>
            <?php if($user['options'][7]==1){?>
              <div class="form-text">Tokens:
                <a class="badger badge-secondary" href="#" onclick="$('#optOutLayout').summernote('insertText','{optOutLink}');return false;">{optOutLink}</a>
              </div>
              <div class="row">
