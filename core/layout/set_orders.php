  ...
  <section class="<?=(isset($_COOKIE['sidebar'])&&$_COOKIE['sidebar']=='small'?'navsmall':'');?>" id="content">
    <div class="container-fluid">
      <div class="card mt-3 bg-transparent border-0 overflow-visible">
        ...
        <hr>
        <legend class="mt-3">Postage Tracking Options</legend>
        ...
        <hr>
        <legend class="mt-3">Australia Post</legend>
...
<?php /* Payment Options to Pay Orders */?>
        ...
        <hr>
        <legend class="mt-3">Discount Ranges</legend>
        <div class="form-row">
          ...
          <label class="p-0 mt-0 ml-3" for="discountRangeCalculations">Discount Range Calculations</label>
        </div>
        ...
        <hr>
        <legend class="mt-3">Banking</legend>
        <div class="row">
        ...
        <hr>
        <legend class="mt-3">PayPal</legend>
...
<?php /*
        ...
        <legend class="mt-3">Stripe</legend>
        ...
        <div class="form-row mt-3">
          ...
          <label class="p-0 mt-0 ml-3" for="enableAfterpay">Enable AfterPay</label>
        </div>
        <hr>
        <legend class="mt-3">Order Processing</legend>
        <div class="form-row">
        ...
        <div class="form-row mt-3">
          <label for="oEN">Order&nbsp;Notes</label>
        ...
        <div class="form-row">
          ...
          <label class="p-0 mt-0 ml-3" for="readNotification">Read Reciept</label>
        </div>
        <div class="form-row">
