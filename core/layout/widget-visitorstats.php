...
<?php       }
    ...
    if($rss['cnt']>0){?>
      <a class="card stats warning col-6 col-sm-4 m-0 p-2 m-sm-1" href="<?= URL.$settings['system']['admin'].'/payments';?>">
        <span class="icon"><i class="i i-5x">hosting</i></span>
        <span class="h5">Site Payments</span>
        <span class="p-0">
...
<?php       }
  ...
  if($user['options'][3]==1){
    if($nm['cnt']>0){?>
      <a class="card stats col-6 col-sm-4 m-0 p-2 m-sm-1" href="<?= URL.$settings['system']['admin'].'/messages';?>">
  ...
  if($nb['cnt']>0){?>
      <a class="card stats col-6 col-sm-4 m-0 p-2 m-sm-1" href="<?= URL.$settings['system']['admin'].'/bookings';?>">
  ...
  <?php }
  if($pc['cnt']>0){?>
      <a class="card stats col-6 col-sm-4 m-0 p-2 m-sm-1" href="<?= URL.$settings['system']['admin'].'/preferences/tracker?find=call';?>">
  ...
  <?php }
  if($nc['cnt']>0){?>
      <a class="card stats col-6 col-sm-4 m-0 p-2 m-sm-1" href="<?= URL.$settings['system']['admin'].'/comments';?>">
  ...
  <?php }
  if($nr['cnt']>0){?>
      <a class="card stats col-6 col-sm-4 m-0 p-2 m-sm-1" href="<?= URL.$settings['system']['admin'].'/reviews';?>">
  ...
  <?php }
  if($nt['cnt']>0){?>
      <a class="card stats col-6 col-sm-4 m-0 p-2 m-sm-1" href="<?= URL.$settings['system']['admin'].'/content/type/testimonials';?>">
  ...
  if($user['options'][4]==1){
    if($po['cnt']>0){?>
      <a class="card stats col-6 col-sm-4 m-0 p-2 m-sm-1" href="<?= URL.$settings['system']['admin'].'/orders';?>">
  ...
  if($sa['cnt']>0){?>
      <a class="card stats col-6 col-sm-4 m-0 p-2 m-sm-1" href="<?= URL.$settings['system']['admin'].'/preferences/security#tab1-3';?>">
