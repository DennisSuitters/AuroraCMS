...
if($col=='password'){
	echo'<script>window.top.window.$("#passButton").removeClass("btn-danger");'.
	'window.top.window.$(".page-block").addClass("d-none");</script>';
}
if($col=='notes'){
	echo'<script>window.top.window.$(".page-block").addClass("d-none");'.
	'window.top.window.$(".note-save button").removeClass("btn-danger");</script>';
}
